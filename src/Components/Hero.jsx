...
const Container = (del) => ({
  ...
  visible: { x: 0, opacity: 1 , transition: { duration: 0.5, delay: del }},
});
      ...
      <div className="flex flex-wrap">
        ...
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center">
            <motion.img initial={{x:100, opacity:0}} animate={{x:0,opacity:1}} transition={{duration:1, delay:1.2}} src={ProfilePic} className="rounded" alt="" />
          </div>
        </div>
      </div>
    </div>
